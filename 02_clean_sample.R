...
twitter_fn <- paste("data/sample_data/twitter_",as.character(nl),"_",as.character(seed),".csv",sep="")
news_fn <- paste("data/sample_data/news_",as.character(nl),"_",as.character(seed),".csv",sep="")
blogs_fn <- paste("data/sample_data/blogs_",as.character(nl),"_",as.character(seed),".csv",sep="")
